...
<body>
  ...
  <div align="center"  data-options="region:'north',collapsible:false" title='' style="background-color:#D6E6DE;overflow:visible;">
    ...
    <!-- 主体部分 -->
    <div data-options="region:'center',title:' 用户管理  | 读者管理'" style="background:#f2f2ea none repeat scroll 0% 0%;">
      <%@include file="inc/user/user_field.inc"%>
      <%@include file="inc/user/dialog_user.inc"%>
    </div>
  </div>
</body>
  <%-- 七牛官方脚本  --%>
  ...
  <%-- 自定义脚本  --%>
  <script type="text/javascript" src="./js/admin/userManage.js"></script>
</html>