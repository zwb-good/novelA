...
<body>
  ...
  <div class="easyui-layout" data-options="fit:true" id="bookshop">
    ...
    <!-- 主体部分 -->
    <div data-options="region:'center',title:' 页面管理 | 轮播图片'" style="background:#f2f2ea none repeat scroll 0% 0%;">
      <%@include file="inc/carousel/carousel_field.inc"%>
      <%@include file="inc/carousel/dialog_carousel.inc"%>
    </div>
  </div>
</body>
  <%-- 七牛官方脚本  --%>
  ...
  <%-- 自定义脚本  --%>
  <script type="text/javascript" src="./js/admin/carouselManage.js"></script>
</html>