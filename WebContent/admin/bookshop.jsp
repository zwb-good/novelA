...
<head>
  ...
  <script type="text/javascript" src="./js/admin/bookshop.js"></script>
</head>
<body>
  <!-- easyUI布局 -->
  <div class="easyui-layout" data-options="fit:true" id="bookshop">
    ...
    <!-- 主体部分 -->
    <div data-options="region:'center',title:' 页面管理 | 书城页面'" style="background:#f2f2ea none repeat scroll 0% 0%;">
      <%@include file="inc/bookshop/bookshop_field.inc"%>
      <%@include file="inc/bookshop/dialog_bookshop.inc"%>
    </div>
  </div>
</body>
</html>