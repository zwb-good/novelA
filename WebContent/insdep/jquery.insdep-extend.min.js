...
$.extend($.fn.textbox.defaults,{height:20});
//$.extend($.fn.passwordbox.defaults,{height:20});
$.extend($.fn.combo.defaults,{height:20});
$.extend($.fn.combobox.defaults,{height:20});
$.extend($.fn.combogrid.defaults,{height:20});
$.extend($.fn.combotree.defaults,{height:20});
//$.extend($.fn.combotreegrid.defaults,{height:20});
...
$.extend($.fn.datetimespinner.defaults,{height:20});
$.extend($.fn.numberbox.defaults,{height:20});
$.extend($.fn.spinner.defaults,{height:20});


$.extend($.fn.numberspinner.defaults,{height:20});//上线数字不能使用
$.extend($.fn.searchbox.defaults,{height:20});
$.extend($.fn.filebox.defaults,{height:20});

$.extend($.fn.validatebox.defaults,{height:20});
